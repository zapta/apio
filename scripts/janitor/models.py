...
class JanitorRequirements:
    ...
    #     )
    #     self.should_be_consistent.check_partitioning(
    #         requirements1.should_be_consistent,
    #         requirements2.should_be_consistent,
    #     )
    ...
    #     assert isinstance(self.should_be_consistent, ReleaseSet)
    ...
    def is_empty(self) -> bool:
        ...
        #     and len(self.should_be_consistent) == 0
